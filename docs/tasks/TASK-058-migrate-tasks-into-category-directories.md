...
- [ ] Category directories exist for the controlled task categories.
- [ ] Existing task files are moved into the correct category directories
      without renaming the files.
- [ ] `docs/tasks/README.md` links resolve to the new task paths.
- [ ] Existing task/spec cross-references to moved task files are updated.
