    ...
    vec![
        ...
        Explanation {
            ...
            constraints: &[
                ...
                "`DisplayFile.content_type` and `DisplayUrl.content_type` override fence detection; otherwise `.java`, `.md`, `.markdown`, `.sql`, `.xml`, `Dockerfile`, and `Dockerfile-*` are detected as lowercase `dockerfile`, with other extensions falling back to `text`.",
