...
fn build_skill_document() -> String {
    let lines = vec![
        ...
        "- Use `sw example <EntryType>` to get a current YAML snippet for entries such as `Breakpoint`, `Command`, `DisplayFile`, `DisplayUrl`, `Patch`, or `Prerequisite`.".to_string(),
    ...
    vec![
        ...
        Explanation {
            ...
            inputs: &[
                ...
                "Supported topics currently include `Breakpoint`, `Command`, `DisplayFile`, `DisplayUrl`, `Patch`, and `Prerequisite`.",
            ],
            outputs: &[
