...
fn build_skill_document() -> String {
    let lines = vec![
        "---".to_string(),
        "name: sw".to_string(),
        "description: Use this skill when the user needs help authoring, validating, converting, or running Sociable Weaver (`sw`) runbooks.".to_string(),
        "---".to_string(),
        "".to_string(),
        "# sw".to_string(),
        "".to_string(),
        "Use this skill when working with Sociable Weaver (`sw`), a CLI for executable documentation runbooks.".to_string(),
        "".to_string(),
        ...
        "".to_string(),
        "```shell".to_string(),
        "sw explain --all".to_string(),
        "```".to_string(),
        "".to_string(),
        "Treat that output, `sw help`, and the repository specs as authoritative. Do not rely on cached assumptions about runbook fields, defaults, or supported subcommands.".to_string(),
        "".to_string(),
        ...
        "- Use `sw format --input-file <runbook>` to rewrite a runbook using canonical formatting.".to_string(),
        ...
        "- Before changing user-visible behavior in this repository, update the spec and task first.".to_string(),
    ...
    vec![
        ...
        Explanation {
            ...
            constraints: &[
                ...
                "`DisplayFile.content_type` and `DisplayUrl.content_type` override fence detection; otherwise `.java`, `.md`, `.markdown`, `.sh`, `.sql`, `.xml`, `Dockerfile`, and `Dockerfile-*` are detected as lowercase `dockerfile`, with other extensions falling back to `text`.",
